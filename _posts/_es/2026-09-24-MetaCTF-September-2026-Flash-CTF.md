...
<div style="text-align:center">
  <img src="http://192.168.92.128/1.png" alt="SkillBit logo" class="blog-image" onclick="expandImage(this)">
</div>
...
Al extraer y ejecutar el binario [careless-talk](https://raw.githubusercontent.com/MateoNitro550/MateoNitro550.github.io/main/assets/2022-01-17-KnightCTF-2022/careless-talk.zip), nos daremos cuenta de que nos pregunta por un _watchword_ que no conocemos. Lo primero que podemos hacer es utilizar `strings` para buscar cadenas de texto imprimibles.
...
Al abrir el [archivo adjunto]() no vamos a observar nada relevante, no obstante, la descripción del reto nos da una pista bastante importante con la frase _walk out_. Podemos hacer uso de `binwalk`, una herramienta para analizar archivos binarios e identificar y extraer archivos embebidos.
